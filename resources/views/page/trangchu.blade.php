								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-body">
											<p class="single-item-title">{{$new->image}}</p>
											<p class="single-item-price">
												{{$new->unit_price}} đồng
											</p>
											<p class="single-item-price">
												{{$new->promotion_price}} đồng
											</p>
										</div>
							...
							@foreach($noibat_pro as $noibat)
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-body">
											<p class="single-item-title">{{$noibat->image}}</p>
											<p class="single-item-price">
												{{$noibat->unit_price}} đồng
											</p>
											<p class="single-item-price">
												{{$noibat->promotion_price}} đồng
											</p>
										</div>
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="shopping_cart.html"><i class="fa fa-shopping-cart"></i></a>
